// VIOLATION: Static mutable fields are shared across all instances.
// Multiple threads executing this task concurrently will have race conditions
// on _executionCount and _lastProcessedFile.
using System.IO;
