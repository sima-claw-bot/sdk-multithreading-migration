// VIOLATION: Uses Environment.CurrentDirectory inside GetEffectiveBasePath() instead of TaskEnvironment
using System;
...
namespace UnsafeThreadSafeTasks.ComplexViolations
{
    ...
    public class AsyncDelegateViolation : Microsoft.Build.Utilities.Task, IMultiThreadableTask
    {
        ...
        // VIOLATION: returns Environment.CurrentDirectory instead of using TaskEnvironment
