// VIOLATION: Path.GetFullPath() buried 5+ calls deep instead of TaskEnvironment.GetAbsolutePath()
using System;
...
namespace UnsafeThreadSafeTasks.ComplexViolations
{
    ...
    public class DeepCallChainPathResolve : MSBuildTask, IMultiThreadableTask
    {
        ...
        private string ResolveAbsolutePath(string path)
        {
            ...
            // BUG: Should use TaskEnvironment.GetAbsolutePath(path) for thread safety
