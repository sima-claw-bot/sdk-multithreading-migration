// FIXED: Resolves relative path through TaskEnvironment before passing to FileStream constructor.
using System.IO;
using System.Text;
...
namespace FixedThreadSafeTasks.PathViolations
{
    ...
    public class RelativePathToFileStream : Microsoft.Build.Utilities.Task, IMultiThreadableTask
    {
        ...
        public override bool Execute()
        {
            ...
            string resolvedPath = TaskEnvironment.GetAbsolutePath(OutputPath);
